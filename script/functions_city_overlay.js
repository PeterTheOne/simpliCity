...
function updateCitizenMenu(){
	$("#currentTitle").html($(".jobentry").eq($current).children("td").eq(1).html()+"<br/>( Deine: "+$(".jobentry").eq($current).children("td").eq(3).html()+", alle: "+$(".jobentry").eq($current).children("td").eq(6).html()+" )");
